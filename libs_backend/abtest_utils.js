(function(){
  ...
  add_abtest('frequency_of_choose_difficulty', ['0.0', '0.25', '0.5', '1.0'], async function(chosen_algorithm){
  ...
  add_abtest('intervention_suggestion_optout', ['off', 'on'], async function(chosen_algorithm){
